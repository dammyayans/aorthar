...
.greybg{
  background-color: ${props => props.theme.mode === 'dark' ? '#111' : '#F3F3F3'};
}
.heroheroL{
...
.a-get-started-testimonies img{
  border: ${props => props.theme.mode === 'dark' ? '7px solid #343434' : '7px solid #fff'};
}
.toggleButton{
  background-color: ${props => props.theme.mode === 'dark' ? '#343434' : '#000'};   
